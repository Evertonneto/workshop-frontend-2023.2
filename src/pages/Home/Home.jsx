    ...
    return (
        <div>
            ...
            <div className='main flex flex-col justify-center items-center text-lg text-zinc-100 '>
                ...
                <p className='mt-28 w-2/3 '>A saga Star Wars se passa em uma galáxia muito, muito distante, trazendo o conflito épico entre os Jedi e os Sith. Além de batalhas espaciais, a franquia tem personagens memoráveis, como Luke Skywalker, Darth Vader e a Princesa Leia, sendo um marco na cultura pop.</p>
            </div>
        </div>
